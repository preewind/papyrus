...
private:
    void renderSearchOverlay(RenderContext &renderContext, const SearchSession &session, const TextLayout &textLayout, const SearchLayout &searchLayout);
    ...
    void renderSearchText(RenderContext &renderContext, const SearchSession &session, const SearchLayout &searchLayout, const SearchViewport &viewport);
