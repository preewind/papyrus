...
private:
    ...
    void renderSelection(Renderer &renderer, const Editor &editor, const EditorViewport &viewport, const LayoutConfig &layoutConfig);
    ...
    void renderSearchMatches(Renderer &renderer, const Editor &editor, const EditorViewport &viewport, const LayoutConfig &layoutConfig);
};